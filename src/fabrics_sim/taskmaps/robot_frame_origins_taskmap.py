...
class RobotFrameOriginsTaskMap(BaseMap):
    def __init__(self, urdf_path, robot_base_transform: wp.transform, link_names, batch_size, device):
        """
        Constructor for building the desired robot taskmap.
        -----------------------------------------
        :param urdf_path: str, robot URDF filepath
        :param robot_base_transform: wp.Transform, robot base transform
    ...
    def init_robot_kinematics(self, batch_size):
        ...
        self.robot_kinematics = Kinematics(self.urdf_path, self.robot_base_transform,
                                           batch_size, multithreading,
                                           device=self.device)
